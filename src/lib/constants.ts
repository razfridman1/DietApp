...
export const T = {
  ...
  analytics: {
    ...
    rangeTitle: "ממוצע בטווח תאריכים",
    rangeSubtitle: "בחר/י תאריך התחלה וסיום לחישוב הממוצעים בטווח",
    rangeFrom: "מתאריך",
    rangeTo: "עד תאריך",
    rangeCompute: "חישוב ממוצעים",
    rangeComputing: "מחשב...",
    rangeDaysCount: "ימים בטווח",
    rangeInvalid: "טווח לא תקין — תאריך ההתחלה חייב להיות לפני או שווה לתאריך הסיום",
    rangeNoData: "אין נתונים מתועדים בטווח שנבחר",
  },
  insights: {
    title: "אנליטיקה חכמה",
